  ...
  return (
    <>
      ...
      <section className="homes">
        <div className="home">
          <img src="/images/house-1.jpeg" alt="House 1" className="home__img" />
        ...
        {/* end home 1 */}
        <div className="home">
          <img src="/images/house-2.jpeg" alt="House 2" className="home__img" />
          <svg className="home__like">
            <use href={sprite + '#icon-heart-full'} />
          </svg>
        ...
        {/* end home 2 */}
        <div className="home">
          <img src="/images/house-3.jpeg" alt="House 3" className="home__img" />
          <svg className="home__like">
            <use href={sprite + '#icon-heart-full'} />
          </svg>
        ...
        {/* end home 4 */}
        <div className="home">
          <img src="/images/house-5.jpeg" alt="House 5" className="home__img" />
          <svg className="home__like">
            <use href={sprite + '#icon-heart-full'} />
          </svg>
          <h5 className="home__name">Beautiful Family House</h5>
        ...
        {/* end home 5 */}
        <div className="home">
          <img src="/images/house-6.jpeg" alt="House 6" className="home__img" />
          <svg className="home__like">
            <use href={sprite + '#icon-heart-full'} />
          </svg>
          <h5 className="home__name">Beautiful Family House</h5>
